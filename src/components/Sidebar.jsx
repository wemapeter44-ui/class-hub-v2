  ...
  return (
    <>
      <button
        ...
        className="lg:hidden fixed top-3 left-3 z-50 bg-slate-900/90 backdrop-blur-md border border-slate-800 rounded-md p-2 text-white active:scale-95 transition"
      ...
      <aside
        className={`
          ...
          w-56 bg-slate-950 border-r border-slate-800/60
      ...
      >
        <div className="h-14 flex items-center gap-2.5 px-4 border-b border-slate-800/60 flex-shrink-0">
          ...
          <div className="min-w-0 flex-1">
            <h1 className="text-xs font-semibold text-white leading-tight tracking-tight">Class Hub</h1>
            <p className="text-[10px] text-slate-600 font-medium tracking-wide">M1-C</p>
          </div>
          <button
            onClick={() => setIsOpen(false)}
            className="lg:hidden text-slate-500 hover:text-white p-1 -mr-1"
        ...
        <nav className="flex-1 overflow-y-auto p-2.5 space-y-0.5">
          <p className="px-2.5 py-2 text-[10px] font-semibold text-slate-600 uppercase tracking-wider">
            Menu
          </p>
          {links.map(link => {
        ...
        <div className="p-2.5 border-t border-slate-800/60 flex-shrink-0">
